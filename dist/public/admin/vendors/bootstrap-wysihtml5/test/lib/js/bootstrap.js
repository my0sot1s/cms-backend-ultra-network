...
!function ($) {
  ...
  $.fn.modal = function (option) {
    return this.each(function () {
      ...
      if (typeof option == 'string') data[option]();else
  ...
  Typeahead.prototype = {
    ...
    sorter: function sorter(items) {
      ...
      while (item = items.shift()) {
        if (!item.toLowerCase().indexOf(this.query.toLowerCase())) beginswith.push(item);else
        if (~item.indexOf(this.query)) caseSensitive.push(item);else
