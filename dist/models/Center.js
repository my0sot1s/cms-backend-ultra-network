...
var update = exports.update = function () {var _ref2 = (0, _asyncToGenerator3.default)(regeneratorRuntime.mark(
  function _callee2(_ref3) {var _id = _ref3._id,link = _ref3.link,tag = _ref3.tag,title = _ref3.title;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
              Model.findByIdAndUpdate({ _id: _id }, {
                $set: {
                  link: link,
                  tag: tag,
                  title: title } }));case 2:return _context2.abrupt('return', _context2.sent);case 3:case 'end':return _context2.stop();}}}, _callee2, this);}));return function update(_x2) {return _ref2.apply(this, arguments);};}();var _mongoose = require('mongoose');var _mongoose2 = _interopRequireDefault(_mongoose);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // import data from '../../data.json'
