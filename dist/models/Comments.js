...
//   })
// }
var find = exports.find = function find(limit, page) {var query = Model.find({}).sort({ dateCreate: -1 }).skip(limit && page ? limit * page : 0).limit(limit || 5);return query;}; // for create field
async function save(params) {var result = await new Model(params).save();return result;} // find and update
async function update(_ref) {var _id = _ref._id,content = _ref.content;return await Model.findByIdAndUpdate({ _id: _id }, { $set: { content: content } });}exports.default = Model;