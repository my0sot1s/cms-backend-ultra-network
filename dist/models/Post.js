...
async function update(_ref) {var _id = _ref._id,post = _ref.post,media = _ref.media;return await Model.findByIdAndUpdate({ _id: _id }, { $set: { post: post, media: media } });}exports.default = Model;