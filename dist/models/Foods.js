...
async function update(_ref) {var _id = _ref._id,link = _ref.link,tag = _ref.tag,title = _ref.title,price = _ref.price,fomular = _ref.fomular;return await Model.findByIdAndUpdate({ _id: _id }, { $set: { link: link, tag: tag, title: title, fomular: fomular, price: price } });}exports.default =
